...
UI_MAIN = ["ui_auth", "ui_reset", "ui_account", "ui_tenant", "ui_abandon", "ui_dirs", "ui_export", "ui_mgr_ocr", "ui_ocr_card", "ui_forecast_zero", "ui_ocr_settings", "ui_demo_restore", "prod_bundle_check"]
